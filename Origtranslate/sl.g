...
#  Degree, Evaluate, Factorial, GF, Gcd, Integers, IsEven, IsOdd, IsPrime,
#  IsPrimePower, LHS, MatrixAlgebra, Ngens, PresentationForN, PrimitiveElement,
#  RHS, SLConvertToStandard, SLGeneratorOfCentre, SLPGroup, SLPresentation,
#  SLPresentationToStandard, SLStandardToPresentation,
#  StandardPresentationForSL, Universe, Zero, phi, tau

#  Defines: PresentationForN, SLConvertToStandard, SLGeneratorOfCentre,
#  SLGenerators, SLPresentation, SLPresentationToStandard,
#  SLStandardToPresentation, SL_Order_NSubgroup, StandardPresentationForSL
...
#     November 2017
#  ///////////////////////////////////////////////////////////////////////
StandardPresentationForSL:=function(d,q)
...
local Presentation,Projective;
  ...
  return StandardPresentationForSL(d,GF(q)
   :Presentation:=Presentation,Projective:=Projective);
end;

StandardPresentationForSL:=function(d,K)
...
function(d,q,W)
local L,U,V,delta,m,z;
  L:=SLPresentationToStandard(d,q);
  L:=Evaluate(L,List([1..Ngens(W)],i->W.i));
  U:=L[1];
  V:=L[2];
  delta:=L[4];
