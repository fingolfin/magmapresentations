...
#  Global Variables used: IsEven, IsOdd, IsPrimePower,
#  StandardPresentationForOmega

#  Defines: StandardPresentationForOmega
...
#     November 2017
#  ///////////////////////////////////////////////////////////////////////
StandardPresentationForOmega:=function(d,F)
...
local Presentation,Projective,Type;
  ...
  return StandardPresentationForOmega(d,Size(F)
   :Projective:=Projective,Presentation:=Presentation,Type:=Type);
end;

StandardPresentationForOmega:=function(d,q)
